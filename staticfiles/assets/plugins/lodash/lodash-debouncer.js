...
function debounce(e, t, r) {
    ...
    return t = toNumber(t) || 0, isObject(r) && (j = !!r.leading, l = (y = "maxWait" in r) ? nativeMax(toNumber(r.maxWait) || 0, t) : l, p = "trailing" in r ? !!r.trailing : p), a.cancel = function() {
