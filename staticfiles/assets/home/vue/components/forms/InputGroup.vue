<template>
    <div class="mb-3">
        ...
        <div class="input-group">
            ...
            <input :required="required" :type="getType()" class="form-control" :placeholder="placeholder || label"
                :aria-label="id" :aria-describedby="id" :id="id || name" :value="inputValue"
                @input="updateInputValue($event)" :name="name" :ref="name" />
