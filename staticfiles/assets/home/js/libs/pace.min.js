...
!function () {
    ...
    if (typeof Pace !== 'undefined') {
       Pace.on('progress', function (progress) {
          var adjustedProgress = Math.floor(progress / 75) * 75; // Progress dengan kelipatan
          var opacity = 1 - adjustedProgress / 100;
          var paceElement = document.querySelector('.pace.pace-active');
          if (paceElement) {
             paceElement.style.backgroundColor = 'rgba(255, 255, 255,' + opacity + ')';
          }
       });
    }
 }.call(this);
