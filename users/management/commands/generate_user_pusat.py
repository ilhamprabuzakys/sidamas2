...
from users.models import Profile, Satker, SatkerPusat

class Command(BaseCommand):
    help = "Generate data user BNN Pusat"
    separator = '-----'

    processed_count = 0
    list_satker = SatkerPusat.objects.all()
    total_count = SatkerPusat.objects.count()
